report 70118 "Posted-Sales-Invoice"
{
    ...
    DefaultRenderingLayout = "CustomSalesInvoice.rdlc";
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column("MOF"; CompanyInfo."MOF #") { }
            column(Commerial_registration; CompanyInfo."Registration No.") { }
            column(CountryRegion; CompanyInfo."Country/Region Code") { }
            ...
            begin
                ...
                Clear(AmountInWords);
                ConvertAmountIntoTextRec.FormatNoTextWithCurrency(AmountInWords, "Amount Including VAT", "Currency Code");

                Clear(DimensionProjectName);
                DimensionRec.reset();
                DimensionRec.SetRange(code, Header."Shortcut Dimension 1 Code");
                if DimensionRec.FindSet() then begin
                    DimensionProjectName := DimensionRec.Name;
                end;
    ...
    rendering
    {
        layout("CustomSalesInvoice.rdlc")
        {
            Type = RDLC;
            LayoutFile = 'src/report/Layouts/PostedSalesInvoice.rdlc';
            Caption = 'Custom Sales Invoice (RDLC)';
            Summary = 'The Custom Sales Invoice (RDLC) is the most detailed layout and provides most flexible layout options.';
        }
    }
    ...
    var
        ConvertAmountIntoTextRec: Codeunit "MASQ Format No Text";
        AmountInWords: Text[200];
        DimensionRec: record "Dimension Value";
        DimensionProjectName: text;
        SrNo: Integer;
