Report 70109 "Purchase - Receipt Updated"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Purchase Receipt-Updated.rdl';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
                    {
                        ...
                        begin
                            ...
                            if "Purch. Rcpt. Line"."Job No." <> '' then begin
                                Job.SetRange("No.", "Purch. Rcpt. Line"."Job No.");
                                if Job.FindFirst() then begin
                                    ProjCode := "Purch. Rcpt. Line"."Job No.";
                                    ProjName := Job.Description;
                                end;
                            end
                            else
                                if "Purch. Rcpt. Line"."Job No." = '' then begin
                                    DimensionValue.SetRange(Code, "Purch. Rcpt. Line"."Shortcut Dimension 1 Code");
                                    if DimensionValue.FindFirst() then begin
                                        ProjCode := "Purch. Rcpt. Line"."Shortcut Dimension 1 Code";
                                        ProjName := DimensionValue.Name;
                                    end;
                                end;
