report 70113 "Delivery Order before posting"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Delivery Order before posting.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            {
                DataItemTableView = sorting("Document No.", "Line No.") where("Qty. to Ship" = filter(<> 0));
            ...
            begin
                ...
                if (not DimensionSetEntry.Get("Sales Header"."Dimension Set ID", 'PROJECT')) then begin
