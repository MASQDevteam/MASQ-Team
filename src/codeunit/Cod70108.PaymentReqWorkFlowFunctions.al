codeunit 70108 "Payment Req WorkFlow Functions"
{
    ...
    var
        Resptxt: Label 'Change Status of the Payment Request';
        WorkflowResponseHandling: Codeunit "Workflow Response Handling";
    begin
        WorkflowResponseHandling.AddResponseToLibrary(PaymentReqAppCode, 70102, Resptxt, 'Group 0');
    end;
    ...
    var
        Resptxt: Label 'Change Status of the Payment Request Cancel';
        WorkflowResponseHandling: Codeunit "Workflow Response Handling";
    begin
        WorkflowResponseHandling.AddResponseToLibrary(PaymentReqCancelCode, 70102, Resptxt, 'Group 2');
    end;
    ...
    var
        Resptxt: Label 'Change Status of the Payment Request Reject';
        WorkflowResponseHandling: Codeunit "Workflow Response Handling";
    begin
        WorkflowResponseHandling.AddResponseToLibrary(PaymentReqRejectCode, 70102, Resptxt, 'Group 0');
    end;
    ...
    var
        Resptxt: Label 'Change Status of the Payment Request Approved';
        WorkflowResponseHandling: Codeunit "Workflow Response Handling";
    begin
        WorkflowResponseHandling.AddResponseToLibrary(PaymentReqApprovedCode, 70102, Resptxt, 'Group 0');
    end;
    ...
    var
        Resptxt: Label 'Send Email to Approver Payment Request';
        WorkflowResponseHandling: Codeunit "Workflow Response Handling";
    begin
        WorkflowResponseHandling.AddResponseToLibrary(PaymentReqSendEmailCode, 70102, Resptxt, 'Group 0');
    end;
    ...
    var
        PaymentRequest: Record "SUPPLIER PAYMENT REQUEST";
    begin
        case RecRef.Number of
            DATABASE::"SUPPLIER PAYMENT REQUEST":
                begin
                    RecRef.SetTable(PaymentRequest);
                    PaymentRequest.Validate(Status, PaymentRequest.Status::"Pending Approval");
            ...
            CASE WorkflowResponse."Function Name" OF
                PaymentReqAppCode://Response
                    BEGIN
                        ...
                        PaymentRequest.Status := PaymentRequest.Status::"Pending Approval";
                ...
                PaymentReqRejectCode(): //Response
                    BEGIN
                        ...
                        PaymentRequest.Status := PaymentRequest.Status::Declined;
                        PaymentRequest.Modify();
                        ResponseExecuted := true;
                    END;
    ...
    [EventSubscriber(ObjectType::Page, 70101, 'OnAfterActionEvent', 'Send Approval Request', false, false)]//Handle the Event
    local procedure RPurchAppEvent(var Rec: Record "SUPPLIER PAYMENT REQUEST")
    var
    ...
    begin
        WorkflowEventHandling.AddEventToLibrary(RunWorkflowOnSendPaymentReqForApprovalCode, 70102, EventText, 0, FALSE);
        WorkflowEventHandling.AddEventToLibrary(RunWorkflowOnCancelPaymentReqApprovalRequestCode, DATABASE::"SUPPLIER PAYMENT REQUEST",
    ...
    [EventSubscriber(ObjectType::Page, 70101, 'OnAfterActionEvent', 'CancelApprovalRequest', false, false)]
    local procedure PurchaseReqPageOnCancelApprovalRequestAction(var Rec: Record "SUPPLIER PAYMENT REQUEST")//Handle the Event
    begin
    ...
    begin
        WorkflowSetup.InsertTableRelation(Database::"SUPPLIER PAYMENT REQUEST", 0, Database::"Approval Entry", 22);//link the pk to approval entry
    end;
        ...
        case RecRef.Number of
            DATABASE::"SUPPLIER PAYMENT REQUEST":
                begin
                    ...
                    ApprovalEntryArgument.Amount := PaymentRequest."Total Requested Amount";
    ...
    begin
        IF ApprovalEntry."Table ID" = 70102 then
            IsHandled := true;
    end;
