codeunit 70106 "MASQ Email"
{
    ...
    begin
        ...
        Body += StrSubstNo('<tr><td>URL : </td><td><a href="%1" target="_blank">Click here to open the approval page</a></td></tr>',
                GetUrl(ClientTypeManagement.GetCurrentClientType(), CompanyName, ObjectType::Page, Page::"Requests to Approve", ApprovalEntry));
        Body += '</table></br><br>';
        Body += 'Thank you.<br><br>';
        Body += 'Regards,';
